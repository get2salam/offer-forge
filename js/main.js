const SPEC = {
  "slug": "offer-forge",
  "title": "Offer Forge",
  "description": "Shape productized service offers with promise, scope, proof, and pricing.",
  "lede": "Design sharper productized offers with buyer fit, proof assets, and cleaner review timing.",
  "heroEyebrow": "Offer design workspace",
  "boardTitle": "Offer forge board",
  "boardSubtitle": "A local-first board for refining promise, scope, proof, and pricing into a stronger offer.",
  "accent": "A good offer gets easier to sell when the promise, scope, proof, and pricing are visible in one place.",
  "itemLabel": "offer block",
  "itemPluralLabel": "Offer blocks",
  "labels": {
    "title": "Offer block",
    "note": "Offer note",
    "category": "Block type",
  ...
  "textTwo": {
    "label": "Proof asset",
    "default": "What proves this block"
  },
  "date": {
    "label": "Next review"
  },
  ...
  "defaults": {
    "note": "Capture the specific language that makes the offer easier to buy."
  },
  "stats": {
    "totalLabel": "Offer blocks",
    "motionLabel": "In refinement",
    "dueLabel": "Review soon"
  },
  "insights": {
    "topLabel": "Strongest offer block",
    "dateLabel": "Next offer review",
    "metricLabel": "Best buyer fit"
  },
  "queue": {
    "eyebrow": "Offer queue",
    "title": "What should be refined next",
    "empty": "Sent offer blocks fall out of the active queue."
  },
  "mix": {
    "eyebrow": "Offer mix",
    "title": "How the offer is distributed"
  },
  "emptyTitle": "No offer blocks yet",
  "emptyBody": "Add the promise, scope, proof, and pricing pieces that make the offer credible.",
  "actions": [
    {
      "id": "ready",
      ...
      "days": 2,
      "fromToday": true,
      "toast": "Moved this block toward send-ready."
    },
    {
      "id": "fit-up",
      "label": "Raise buyer fit",
      "mode": "advance",
      "metricDelta": 1,
      "scoreDelta": 1,
      "toast": "Raised the buyer fit for this block."
    },
    {
      "id": "copy-offer",
      "label": "Copy offer note",
      "mode": "copy",
      "key": "note"
    }
  ],
  ...
  "items": [
    ...
    },
    {
      ...
      "date": "2026-04-29",
      "note": "Need to test whether the premium anchor clarifies or confuses."
    }
  ]
};
