  ...
  "slug": "offer-forge",
  "title": "Offer Forge",
  "tagline": "Shape productized service offers with promise, scope, proof, and pricing.",
  "domainLabel": "offers",
  "itemLabel": "offer",
  "emptyTitle": "No offers yet",
  "emptyBody": "Draft the offers you want to sharpen and compare.",
  "seedTitle": "Offer forge",
  "seedSubtitle": "Stress-test your promise, scope, proof, and delivery rhythm.",
  "categories": [
    "Promise",
    "Scope",
    "Proof",
  ...
  "items": [
    {
      ...
      "score": 9,
      "effort": 4,
      "note": "Outcome-led wording feels stronger than describing the underlying stack."
    },
    {
      "title": "Fast audit package",
      "category": "Pricing",
      "state": "Testing",
      "score": 8,
      "effort": 2,
      "note": "Try fixed-scope pricing first so buying feels lighter."
    },
    {
      "title": "Proof stack refresh",
      "category": "Proof",
      "state": "Rough",
      "score": 7,
      "effort": 5,
      "note": "Needs screenshots, before/after examples, and one short testimonial snippet."
    }
  ]
};
